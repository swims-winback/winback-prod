...
class UtilsTest extends TestCase
{
    ...
    public function testDefault()
    {
        ...
        */
        ...
        $this->assertSame('003.003', $utils->getVersion2($back3_soft_list));
        $back4_soft_list = array_diff(scandir(PACK_PATH . deviceTypeArray['12']), array('..', '.'));
        $this->assertSame('003.019', $utils->getVersion2($back4_soft_list));
        ...
        */
        $back3_soft_list = array_diff(scandir($_ENV['PACK_ARCH_PATH'] . deviceTypeArray['14']), array('..', '.'));
        //$this->assertSame('003.003', $utils->getVersion2($back3_soft_list));
        $back4_soft_list = array_diff(scandir($_ENV['PACK_ARCH_PATH'] . deviceTypeArray['12']), array('..', '.'));
        //$this->assertSame('003.019', $utils->getVersion2($back4_soft_list));
        $bio_soft_list = array_diff(scandir($_ENV['PACK_ARCH_PATH'] . deviceTypeArray['13']), array('..', '.'));
        //$this->assertSame('003.001', $utils->getVersion2($bio_soft_list));
        $cryo_soft_list = array_diff(scandir($_ENV['PACK_ARCH_PATH'] . deviceTypeArray['11']), array('..', '.'));
        //$this->assertSame('003.007', $utils->getVersion2($cryo_soft_list));
        $rshock_soft_list = array_diff(scandir($_ENV['PACK_ARCH_PATH'] . deviceTypeArray['10']), array('..', '.'));
        //$this->assertSame('004.002', $utils->getVersion2($rshock_soft_list));
        /* COMPARE FILE */
        //$this->assertSame(??, $utils->compareFile());
        /* CHECK FILE */
        $this->assertSame("WLE256_14_2_v003.003.bin", $utils->checkFileTest('14', $boardType = '2'));
        $this->assertSame("WLE256_12_2_v003.019.bin", $utils->checkFileTest('12', $boardType = '2'));
