...
// create a streaming socket (endpoint for communication), of type TCP/IP
...
{
    echo "\r\n=================== SOCKET CREATE IS OK ===================\r\n";
    // sets sockets option for the socket
    socket_set_option($sock, SOL_SOCKET, SO_REUSEADDR, 1);

    //binds a name to a socket
    if (socket_bind($sock, ADDRESS, PORT) === false) {
        echo "socket_bind() failed : error : " . socket_strerror(socket_last_error($sock)) . "\n";
    }
    else
    {
        echo "\r\n=================== SOCKET BIND IS OK ===================\r\n";
        //listens for a connection in a socket
        if (socket_listen($sock, 5) === false) {
            echo "socket_listen() failed : error : " . socket_strerror(socket_last_error($sock)) . "\n";
        }
        else
        {
            echo "\r\n=================== SOCKET LISTEN IS OK ===================\r\n";
