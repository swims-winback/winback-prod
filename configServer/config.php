...
//if (!defined('RESSOURCE_PATH')) define("RESSOURCE_PATH", ROOT_DIR."/src/Ressource/");
if (!defined('RESSOURCE_PATH')) define("RESSOURCE_PATH", ROOT_DIR."/public/Ressource/");
if (!defined('UPLOAD_PATH')) define("UPLOAD_PATH", ROOT_DIR."/public/uploads/");
...
if (!defined('PACK_PATH')) define("PACK_PATH", RESSOURCE_PATH.'package/');
if (!defined('PACK_FACTORYPATH')) define("PACK_FACTORYPATH", RESSOURCE_PATH.'factory/');
if (!defined('ARCH_PATH')) define("ARCH_PATH", RESSOURCE_PATH.'archive/');
